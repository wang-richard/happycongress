# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 15:10:59 2019
...
urlsList = []
errorsList = []
baseURL = 'https://boyle.house.gov/media-center/press-releases?page='
for counter in range(1, 35):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://boyle.house.gov'+url
...
text_file = open("brendanBoylePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("brendanBoylePressErrors.txt", "w")
