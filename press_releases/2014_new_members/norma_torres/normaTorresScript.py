...
urlsList = []
errorsList = []
baseURL = 'https://torres.house.gov/media-center/press-releases?page='
for counter in range(1, 30):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://torres.house.gov'+url
...
text_file = open("normaTorresPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("normaTorresPressErrors.txt", "w")
