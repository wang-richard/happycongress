...
urlsList = []
errorsList = []
baseURL = 'https://rubengallego.house.gov/media-center/press-releases?page='
for counter in range(1, 37):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://rubengallego.house.gov'+url
...
text_file = open("rubenGallegoPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("rubenGallegoPressErrors.txt", "w")
