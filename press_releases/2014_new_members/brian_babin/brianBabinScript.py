...
urlsList = []
errorsList = []
baseURL = 'https://babin.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 26):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://babin.house.gov/news/'+url
...
text_file = open("brianBabinPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("brianBabinPressErrors.txt", "w")
