# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 20:02:54 2019
...
urlsList = []
errorsList = []
baseURL = 'https://www.ernst.senate.gov/public/index.cfm/press-releases?page='
for counter in range(1, 111):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.ernst.senate.gov'+url
...
text_file = open("joniErnstPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("joniErnstPressErrors.txt", "w")
