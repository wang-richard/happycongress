# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 19:34:26 2019
...
urlsList = []
errorsList = []
baseURL = 'https://www.rounds.senate.gov/newsroom/press-releases?PageNum_rs='
for counter in range(1, 32):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.rounds.senate.gov'+url
...
text_file = open("mikeRoundsPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeRoundsPressErrors.txt", "w")
