# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 10:17:09 2019
...
urlsList = []
errorsList = []
baseURL = 'https://moulton.house.gov/category/news-stories/press-releases/page/'
...
text_file = open("sethMoultonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("sethMoultonPressErrors.txt", "w")
