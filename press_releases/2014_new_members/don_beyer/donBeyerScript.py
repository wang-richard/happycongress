# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 16:02:46 2019
...
urlsList = []
errorsList = []
baseURL = 'https://beyer.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 49):
    ...
    try:
        ...
        for link in a:
            url = link.attrs['href']
            url = url.strip()
            pressURL = 'https://beyer.house.gov/news/'+url
...
text_file = open("donBeyerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("donBeyerPressErrors.txt", "w")
