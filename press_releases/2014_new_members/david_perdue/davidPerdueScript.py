# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 17:32:03 2019
...
urlsList = []
errorsList = []
baseURL = 'https://www.perdue.senate.gov/news/press-releases?PageNum_rs='
for counter in range(1, 56):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.perdue.senate.gov'+url
...
text_file = open("davidPerduePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("davidPerduePressErrors.txt", "w")
