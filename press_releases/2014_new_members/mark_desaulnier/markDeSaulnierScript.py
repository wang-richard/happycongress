...
urlsList = []
errorsList = []
baseURL = 'https://desaulnier.house.gov/media-center/press-releases?page='
for counter in range(1, 32):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://desaulnier.house.gov'+url
...
text_file = open("markDeSaulnierPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("markDeSaulnierPressErrors.txt", "w")
