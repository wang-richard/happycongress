...
urlsList = []
errorsList = []
baseURL = 'https://hice.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 31):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://hice.house.gov/news/'+url
...
text_file = open("jodyHicePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jodyHicePressErrors.txt", "w")
