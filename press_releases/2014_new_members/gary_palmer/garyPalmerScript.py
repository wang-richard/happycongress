...
urlsList = []
errorsList = []
baseURL = 'https://palmer.house.gov/media-center/press-releases?page='
for counter in range(1, 24):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://palmer.house.gov'+url
...
text_file = open("garyPalmerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("garyPalmerPressErrors.txt", "w")
