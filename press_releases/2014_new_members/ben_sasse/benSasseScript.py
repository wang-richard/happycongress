...
urlsList = []
errorsList = []
baseURL = 'https://www.sasse.senate.gov/public/index.cfm/press-releases?page='
for counter in range(1, 45):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.sasse.senate.gov'+url
...
text_file = open("benSassePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("benSassePressErrors.txt", "w")
