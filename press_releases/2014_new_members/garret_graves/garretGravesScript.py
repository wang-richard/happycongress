# -*- coding: utf-8 -*-
"""
Created on Tue Apr 23 17:03:13 2019
...
urlsList = []
errorsList = []
baseURL = 'https://garretgraves.house.gov/media-center/press-releases?page='
for counter in range(1, 14):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://garretgraves.house.gov'+url
...
text_file = open("garretGravesPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("garretGravesPressErrors.txt", "w")
