...
urlsList = []
errorsList = []
baseURL = 'https://walker.house.gov/media-center/press-releases?page='
for counter in range(1, 36):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://walker.house.gov'+url
...
text_file = open("markWalkerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("markWalkerPressErrors.txt", "w")
