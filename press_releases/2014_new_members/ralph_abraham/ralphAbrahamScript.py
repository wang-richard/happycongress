...
urlsList = []
errorsList = []
baseURL = 'https://abraham.house.gov/media-center/press-releases?page='
for counter in range(1, 21):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://abraham.house.gov'+url
...
text_file = open("ralphAbrahamPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("ralphAbrahamPressErrors.txt", "w")
