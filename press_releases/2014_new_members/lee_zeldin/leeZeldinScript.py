# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 23:22:22 2019
...
urlsList = []
errorsList = []
baseURL = 'https://zeldin.house.gov/media-center/press-releases?page='
for counter in range(1, 129):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://zeldin.house.gov'+url
...
text_file = open("leeZeldinPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("leeZeldinPressErrors.txt", "w")
