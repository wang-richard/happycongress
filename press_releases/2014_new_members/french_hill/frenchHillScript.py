# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 22:49:10 2019
...
urlsList = []
errorsList = []
baseURL = 'https://hill.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 56):
    ...
    try:
        ...
        for link in a:
            url = link.attrs['href']
            url = url.strip()
            pressURL = 'https://hill.house.gov/news/'+url
...
text_file = open("frenchHillPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("frenchHillPressErrors.txt", "w")
