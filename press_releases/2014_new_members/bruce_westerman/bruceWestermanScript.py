...
urlsList = []
errorsList = []
baseURL = 'https://westerman.house.gov/media-center/press-releases?page='
for counter in range(1, 41):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://westerman.house.gov'+url
...
text_file = open("bruceWestermanPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bruceWestermanPressErrors.txt", "w")
