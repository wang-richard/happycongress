...
urlsList = []
errorsList = []
baseURL = 'https://katko.house.gov/media-center/press-releases?page='
for counter in range(1, 39):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://katko.house.gov'+url
...
text_file = open("johnKatkoPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnKatkoPressErrors.txt", "w")
