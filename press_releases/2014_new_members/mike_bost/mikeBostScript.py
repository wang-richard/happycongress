...
urlsList = []
errorsList = []
baseURL = 'https://bost.house.gov/media-center/press-releases?page='
for counter in range(1, 35):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://bost.house.gov'+url
...
text_file = open("mikeBostPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeBostPressErrors.txt", "w")
