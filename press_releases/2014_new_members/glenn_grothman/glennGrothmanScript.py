# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 17:11:38 2019
...
urlsList = []
errorsList = []
baseURL = 'https://grothman.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 26):
    ...
    try:
        ...
        for link in a:
            url = link.attrs['href']
            url = url.strip()
            pressURL = 'https://grothman.house.gov/news/'+url
...
text_file = open("glennGrothmanPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("glennGrothmanPressErrors.txt", "w")
