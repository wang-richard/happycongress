...
urlsList = []
errorsList = []
baseURL = 'https://lieu.house.gov/media-center/press-releases?page='
for counter in range(1, 77):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lieu.house.gov'+url
...
text_file = open("tedLieuPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("tedLieuPressErrors.txt", "w")
