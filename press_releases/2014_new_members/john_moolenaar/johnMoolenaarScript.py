...
urlsList = []
errorsList = []
baseURL = 'https://moolenaar.house.gov/media-center/press-releases?page='
for counter in range(1, 28):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://moolenaar.house.gov'+url
...
text_file = open("johnMoolenaarPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnMoolenaarPressErrors.txt", "w")
