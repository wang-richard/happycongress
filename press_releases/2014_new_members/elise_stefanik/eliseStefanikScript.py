# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 18:41:11 2019
...
urlsList = []
errorsList = []
baseURL = 'https://stefanik.house.gov/media-center/press-releases?page='
for counter in range(1, 62):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://stefanik.house.gov'+url
...
text_file = open("eliseStefanikPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("eliseStefanikPressErrors.txt", "w")
