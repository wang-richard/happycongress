...
urlsList = []
errorsList = []
baseURL = 'https://lawrence.house.gov/media-center/press-releases?page='
for counter in range(1, 23):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lawrence.house.gov'+url
...
text_file = open("brendaLawrencePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("brendaLawrencePressErrors.txt", "w")
