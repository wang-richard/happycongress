# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 19:49:12 2019
...
urlsList = []
errorsList = []
baseURL = 'https://rouzer.house.gov/press-releases?page='
for counter in range(1, 22):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://rouzer.house.gov'+url
...
text_file = open("davidRouzerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("davidRouzerPressErrors.txt", "w")
