# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 15:06:05 2019
...
urlsList = []
errorsList = []
baseURL = 'https://buddycarter.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 35):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://buddycarter.house.gov/news/'+url
...
text_file = open("buddyCarterPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("buddyCarterPressErrors.txt", "w")
