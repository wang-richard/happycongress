# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 15:30:17 2019
...
urlsList = []
errorsList = []
baseURL = 'https://ratcliffe.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 26):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://ratcliffe.house.gov/news/'+url
...
text_file = open("johnRatcliffePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnRatcliffePressErrors.txt", "w")
