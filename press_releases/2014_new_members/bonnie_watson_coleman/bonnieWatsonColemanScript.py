# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 11:32:37 2019
...
urlsList = []
errorsList = []
baseURL = 'https://watsoncoleman.house.gov/newsroom/documentquery.aspx?DocumentTypeID=27&Page='
for counter in range(1, 20):
    ...
    try:
        ...
        for link in b:
            url = link.attrs['href']
            url = url.strip()
            pressURL = 'https://watsoncoleman.house.gov/newsroom/'+url
...
text_file = open("bonnieWatsonColemanPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bonnieWatsonColemanPressErrors.txt", "w")
