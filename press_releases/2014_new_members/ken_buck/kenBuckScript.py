...
urlsList = []
errorsList = []
baseURL = 'https://buck.house.gov/media-center/press-releases?page='
for counter in range(1, 15):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://buck.house.gov'+url
...
text_file = open("kenBuckPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("kenBuckPressErrors.txt", "w")
