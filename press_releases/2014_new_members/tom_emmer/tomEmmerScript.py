...
urlsList = []
errorsList = []
baseURL = 'https://emmer.house.gov/media-center/press-releases?page='
for counter in range(1, 29):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://emmer.house.gov'+url
...
text_file = open("tomEmmerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("tomEmmerPressErrors.txt", "w")
