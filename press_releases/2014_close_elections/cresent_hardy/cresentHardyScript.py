# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 23:14:51 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20161208042950/https://hardy.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20161208192225/https://hardy.house.gov/media-center/press-releases?page='
...
text_file = open("cresentHardyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("cresentHardyPressErrors.txt", "w")
