...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222040719/https://poliquin.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222175050/https://poliquin.house.gov/media-center/press-releases?page='
...
text_file = open("brucePoliquinPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("brucePoliquinPressErrors.txt", "w")
