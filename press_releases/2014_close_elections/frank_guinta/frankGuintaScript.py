# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 15:13:18 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20161208035921/https://guinta.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20161208144847/https://guinta.house.gov/media-center/press-releases?page='
...
text_file = open("frankGuintaPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("frankGuintaPressErrors.txt", "w")
