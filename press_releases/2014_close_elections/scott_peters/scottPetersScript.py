# -*- coding: utf-8 -*-
"""
Created on Fri Mar 08 23:00:27 2019
...
baseURL = 'https://scottpeters.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 45):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://scottpeters.house.gov'+url
...
text_file = open("scottPetersPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("scottPetersPressErrors.txt", "w")
