# -*- coding: utf-8 -*-
"""
Created on Sat Mar 09 00:33:05 2019
...
baseURL = 'https://aguilar.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 37):
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://aguilar.house.gov'+url
...
text_file = open("peteAguilarPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("peteAguilarPressErrors.txt", "w")
