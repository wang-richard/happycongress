# -*- coding: utf-8 -*-
"""
Created on Sat Mar 09 00:01:31 2019
...
baseURL = 'https://mcnerney.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 13):
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mcnerney.house.gov'+url
...
text_file = open("jerryMcNerneyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jerryMcNerneyPressErrors.txt", "w")
