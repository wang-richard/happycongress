# -*- coding: utf-8 -*-
"""
Created on Fri Mar 08 23:35:36 2019
...
baseURL = 'https://mooney.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 13):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mooney.house.gov'+url
...
text_file = open("alexMooneyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("alexMooneyPressErrors.txt", "w")
