# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 23:40:55 2019
...
urlsList = []
errorsList = []
baseURL = 'https://web.archive.org/web/20161208184534/http://dold.house.gov/press-releases?page='
...
text_file = open("bobDoldPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bobDoldPressErrors.txt", "w")
