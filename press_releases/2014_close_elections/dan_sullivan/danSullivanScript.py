# -*- coding: utf-8 -*-
"""
Created on Thu Mar 07 16:00:20 2019
...
baseURL = 'https://www.sullivan.senate.gov/newsroom/press-releases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 34):
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.sullivan.senate.gov'+url
...
text_file = open("danSullivanPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("danSullivanPressErrors.txt", "w")
