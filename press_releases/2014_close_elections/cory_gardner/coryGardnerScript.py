# -*- coding: utf-8 -*-
"""
Created on Thu Mar 07 16:41:42 2019
...
baseURL = 'https://www.gardner.senate.gov/newsroom/press-releases?PageNum_rs='
urlsList = []
errorsList = []
...
text_file = open("coryGardnerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("coryGardnerPressErrors.txt", "w")
