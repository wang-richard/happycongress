# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 15:43:16 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20161208011020/https://ashford.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20161208105131/https://ashford.house.gov/media-center/press-releases?page='
...
text_file = open("bradAshfordPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bradAshfordPressErrors.txt", "w")
