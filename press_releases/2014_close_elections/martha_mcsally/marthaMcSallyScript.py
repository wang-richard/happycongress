# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 22:39:25 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181221210954/https://mcsally.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181221230253/https://mcsally.house.gov/media-center/press-releases?page='
...
text_file = open("marthaMcSallyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("marthaMcSallyPressErrors.txt", "w")
