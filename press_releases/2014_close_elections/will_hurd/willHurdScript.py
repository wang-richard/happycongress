# -*- coding: utf-8 -*-
"""
Created on Fri Mar 08 22:31:56 2019
...
baseURL = 'https://hurd.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 35):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://hurd.house.gov'+url
...
text_file = open("willHurdPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("willHurdPressErrors.txt", "w")
