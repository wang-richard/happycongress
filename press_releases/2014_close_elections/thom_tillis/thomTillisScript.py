# -*- coding: utf-8 -*-
"""
Created on Fri Mar 08 14:22:26 2019
...
baseURL = 'https://www.tillis.senate.gov/public/index.cfm/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 79):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.tillis.senate.gov'+url
...
text_file = open("thomTillisPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("thomTillisPressErrors.txt", "w")
