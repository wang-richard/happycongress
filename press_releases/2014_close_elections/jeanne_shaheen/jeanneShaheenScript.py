# -*- coding: utf-8 -*-
"""
Created on Thu Mar 07 19:36:08 2019
...
baseURL = 'https://www.shaheen.senate.gov/news/press?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 76):
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.shaheen.senate.gov'+url
...
text_file = open("jeanneShaheenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jeanneShaheenPressErrors.txt", "w")
