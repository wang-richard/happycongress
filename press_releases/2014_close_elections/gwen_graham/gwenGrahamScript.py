# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 21:33:14 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20161208034535/https://graham.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20161208191458/https://graham.house.gov/media-center/press-releases?page='
...
text_file = open("gwenGrahamPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("gwenGrahamPressErrors.txt", "w")
