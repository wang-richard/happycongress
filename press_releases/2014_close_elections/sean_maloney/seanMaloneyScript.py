# -*- coding: utf-8 -*-
"""
Created on Fri Mar 08 21:06:37 2019
...
baseURL = 'https://seanmaloney.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 56):
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://seanmaloney.house.gov'+url
...
text_file = open("seanMaloneyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("seanMaloneyPressErrors.txt", "w")
