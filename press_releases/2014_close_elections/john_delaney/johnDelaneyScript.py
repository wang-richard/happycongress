# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 17:59:48 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222031502/https://delaney.house.gov/news/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222155340/https://delaney.house.gov/news/press-releases?page='
...
text_file = open("johnDelaneyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnDelaneyPressErrors.txt", "w")
