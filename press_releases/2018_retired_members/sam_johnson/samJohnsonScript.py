# -*- coding: utf-8 -*-
"""
Created on Sun Dec 30 14:16:13 2018
@author: Richard
"""
...
baseURL = 'https://samjohnson.house.gov/news/documentquery.aspx?DocumentTypeID=271&Page='
urlsList = []
errorsList = []
for counter in range(1, 87):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://samjohnson.house.gov/news/'+url
...
text_file = open("samJohnsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("samJohnsonPressErrors.txt", "w")
