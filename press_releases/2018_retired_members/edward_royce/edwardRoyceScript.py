# -*- coding: utf-8 -*-
"""
Created on Mon Dec 17 00:31:25 2018
@author: Richard
"""
...
baseURL = 'https://royce.house.gov/news/documentquery.aspx?DocumentTypeID=61&Page='

urlsList = []
errorsList = []
for counter in range(1, 83):
    ...
    try:
        ...
        for link in a:
            url = link.attrs['href']
            url = url.strip()
            pressURL = 'https://royce.house.gov/news/'+url
...
text_file = open("edwardRoycePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("edwardRoycePressErrors.txt", "w")
