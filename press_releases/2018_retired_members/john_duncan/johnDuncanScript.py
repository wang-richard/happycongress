...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222034349/https://duncan.house.gov/media/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222163803/https://duncan.house.gov/media/press-releases?page='
...
text_file = open("johnDuncanPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnDuncanPressErrors.txt", "w")
