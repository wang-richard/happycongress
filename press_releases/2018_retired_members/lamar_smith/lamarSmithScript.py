# -*- coding: utf-8 -*-
"""
Created on Sat Apr 20 15:35:43 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222072110/https://lamarsmith.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222205428/https://lamarsmith.house.gov/media-center/press-releases?page='
...
text_file = open("lamarSmithPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lamarSmithPressErrors.txt", "w")
