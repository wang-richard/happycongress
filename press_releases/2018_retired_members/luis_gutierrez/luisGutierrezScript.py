# -*- coding: utf-8 -*-
"""
Created on Sat Apr 20 18:37:03 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222003851/https://gutierrez.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222220450/https://gutierrez.house.gov/media-center/press-releases?page='
for counter in range(1, 77):
...
text_file = open("luisGutierrezPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("luisGutierrezPressErrors.txt", "w")
