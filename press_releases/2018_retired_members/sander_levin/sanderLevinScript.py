# -*- coding: utf-8 -*-
"""
Created on Sun Apr 21 18:49:39 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181221230913/https://levin.house.gov/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222125846/https://levin.house.gov/press-releases?page='
for counter in range(1, 119):
...
text_file = open("sanderLevinPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("sanderLevinPressErrors.txt", "w")
