...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222024642/https://issa.house.gov/news-room/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222124812/https://issa.house.gov/news-room/press-releases?page='
for counter in range(1, 193):
...
text_file = open("darellIssaPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("darellIssaPressErrors.txt", "w")
