# -*- coding: utf-8 -*-
"""
Created on Sat Apr 20 12:18:50 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222023657/https://hensarling.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222152404/https://hensarling.house.gov/media-center/press-releases?page='
for counter in range(1, 56):
...
text_file = open("jebHensarlingPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jebHensarlingPressErrors.txt", "w")
