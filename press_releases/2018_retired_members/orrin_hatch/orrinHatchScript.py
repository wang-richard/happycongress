# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 10:26:21 2019
...
urlsList = []
errorsList = []
baseURL = 'https://web.archive.org/web/20181223004344/https://www.hatch.senate.gov/public/index.cfm/releases?page='
...
text_file = open("orrinHatchPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("orrinHatchPressErrors.txt", "w")
