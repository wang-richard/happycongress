# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 21:23:48 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181222020438/https://green.house.gov/media-center/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222152015/https://green.house.gov/media-center/press-releases?page='
...
text_file = open("geneGreenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("geneGreenPressErrors.txt", "w")
