# -*- coding: utf-8 -*-
"""
Created on Sun Apr 21 16:14:03 2019
...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181223112733/https://brady.house.gov/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222072151/https://brady.house.gov/press-releases?page='
...
text_file = open("robertBradyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("robertBradyPressErrors.txt", "w")
