# -*- coding: utf-8 -*-
"""
Created on Sat Dec 29 00:47:56 2018
@author: Richard
"""
...
baseURL = 'https://goodlatte.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
urlsList = []
errorsList = []
for counter in range(1, 81):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://goodlatte.house.gov/news/'+url
...
text_file = open("robertGoodlattePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("robertGoodlattePressErrors.txt", "w")
