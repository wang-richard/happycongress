# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 11:30:06 2019
...
urlsList = []
errorsList = []
baseURL = 'https://web.archive.org/web/20181222015814/https://poe.house.gov/press-releases?page='
...
text_file = open("tedPoePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("tedPoePressErrors.txt", "w")
