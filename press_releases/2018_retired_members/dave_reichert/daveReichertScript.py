...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20181224074857/https://reichert.house.gov/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20181222142430/https://reichert.house.gov/press-releases?page='
...
text_file = open("daveReichertPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("daveReichertPressErrors.txt", "w")
