...
urlsList = []
errorsList = []
baseURL_1 = 'https://web.archive.org/web/20141206013026/https://grimm.house.gov/press-releases'
targetURL = baseURL_1
try:
...
baseURL = 'https://web.archive.org/web/20141206121144/https://grimm.house.gov/press-releases?page='
...
text_file = open("michaelGrimmPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("michaelGrimmPressErrors.txt", "w")
