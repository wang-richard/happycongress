# -*- coding: utf-8 -*-
"""
Created on Sat Mar 09 19:54:22 2019
...
baseURL = 'https://alceehastings.house.gov/news/documentquery.aspx?DocumentTypeID=2397&Page='

urlsList = []
errorsList = []
for counter in range(1, 127):
    ...
    try:
        ...
        for link in a:
            url = link.attrs['href']
            pressURL = 'https://alceehastings.house.gov/news/'+url
...
text_file = open("alceeHastingsPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("alceeHastingsPressErrors.txt", "w")
