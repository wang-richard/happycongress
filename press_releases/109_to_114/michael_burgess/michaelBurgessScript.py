# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 20:00:34 2019
...
baseURL = 'https://burgess.house.gov/news/documentquery.aspx?DocumentTypeID=75&Page='
urlsList = []
errorsList = []
for counter in range(1, 109):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://burgess.house.gov/news/'+url
...
text_file = open("michaelBurgessPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("michaelBurgessPressErrors.txt", "w")
