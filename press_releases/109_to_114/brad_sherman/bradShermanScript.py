# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 18:13:26 2019
...
baseURL = 'https://sherman.house.gov/media-center/press-releases?page='
...
for counter in range(1, 73):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://sherman.house.gov'+url
...
text_file = open("bradShermanPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bradShermanPressErrors.txt", "w")
