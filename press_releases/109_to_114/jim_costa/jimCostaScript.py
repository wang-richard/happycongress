# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 11:47:03 2019
...
baseURL = 'https://costa.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 100):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://costa.house.gov'+url
...
text_file = open("jimCostaPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jimCostaPressErrors.txt", "w")
