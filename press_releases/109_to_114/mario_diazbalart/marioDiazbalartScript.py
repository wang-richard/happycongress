# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 15:42:12 2019
...
baseURL = 'https://mariodiazbalart.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 99):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mariodiazbalart.house.gov'+url
...
text_file = open("marioDiazbalartPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("marioDiazbalartPressErrors.txt", "w")
