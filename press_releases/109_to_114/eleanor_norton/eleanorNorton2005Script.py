# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 11:44:57 2019
...
baseURL = 'https://norton.house.gov/media-center/press-releases?page='

urlsList = []
errorsList = []
for counter in range(386, 401):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://norton.house.gov'+url
...
for targetURL in urlsList:
    ...
    try:
        ...
        a = soup.find('h1', attrs={"id":"page-title"})
        date = a.get_text()
        date = date.strip()
...
text_file = open("eleanorNorton2005Press.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("eleanorNortonPress2005Errors.txt", "w")
