# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 11:29:07 2019
...
baseURL = 'https://ebjohnson.house.gov/media-center/press-releases?page='
...
for counter in range(1, 92):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://ebjohnson.house.gov'+url
...
text_file = open("eddieBerniceJohnsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("eddieBerniceJohnsonPressErrors.txt", "w")
