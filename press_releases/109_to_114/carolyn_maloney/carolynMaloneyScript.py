# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 20:08:38 2019
...
baseURL = 'https://maloney.house.gov/news/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 267):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://maloney.house.gov'+url
...
text_file = open("carolynMaloneyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("carolynMaloneyPressErrors.txt", "w")
