# -*- coding: utf-8 -*-
"""
Created on Tue Apr 09 21:45:08 2019
...
baseURL = 'https://www.murkowski.senate.gov/press/press-releases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(6, 162):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.murkowski.senate.gov'+url
...
text_file = open("lisaMurkowskiPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lisaMurkowskiPressErrors.txt", "w")
