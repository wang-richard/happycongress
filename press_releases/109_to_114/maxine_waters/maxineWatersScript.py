# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 19:33:42 2019
...
baseURL = 'https://waters.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 111):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://waters.house.gov'+url
...
text_file = open("maxineWatersPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("maxineWatersPressErrors.txt", "w")
