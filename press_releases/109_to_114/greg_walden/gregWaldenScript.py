# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 22:47:17 2019
...
baseURL = 'https://walden.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 93):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://walden.house.gov'+url
...
text_file = open("gregWaldenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("gregWaldenPressErrors.txt", "w")
