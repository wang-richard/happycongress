# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 18:27:21 2019
...
baseURL = 'https://jacksonlee.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 58):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://jacksonlee.house.gov'+url
...
text_file = open("sheilaJacksonLeePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("sheilaJacksonLeePressErrors.txt", "w")
