# -*- coding: utf-8 -*-
"""
Created on Tue Apr 09 10:39:16 2019
...
baseURL = 'https://www.lgraham.senate.gov/public/index.cfm/press-releases?page='
urlsList = []
errorsList = []
for counter in range(5, 181):
...
text_file = open("lindseyGrahamPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lindseyGrahamPressErrors.txt", "w")
