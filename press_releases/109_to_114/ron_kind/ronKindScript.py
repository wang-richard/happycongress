# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 15:28:22 2019
...
baseURL = 'https://kind.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 113):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://kind.house.gov'+url
...
text_file = open("ronKindPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("ronKindPressErrors.txt", "w")
