# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 13:57:01 2019
...
baseURL = 'https://mcgovern.house.gov/news/documentquery.aspx?DocumentTypeID=2472&Page='
urlsList = []
errorsList = []
for counter in range(1, 92):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://mcgovern.house.gov/news/'+url
...
text_file = open("jimMcGovernPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jimMcGovernPressErrors.txt", "w")
