# -*- coding: utf-8 -*-
"""
Created on Fri Apr 12 13:20:46 2019
...
baseURL = 'https://www.leahy.senate.gov/press/releases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(5, 254):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.leahy.senate.gov'+url
...
text_file = open("patrickLeahyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("patrickLeahyPressErrors.txt", "w")
