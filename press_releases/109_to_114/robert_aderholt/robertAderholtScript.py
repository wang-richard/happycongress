# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 13:35:30 2019
...
baseURL = 'https://aderholt.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 44):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://aderholt.house.gov'+url
...
text_file = open("robertAderholtPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("robertAderholtPressErrors.txt", "w")
