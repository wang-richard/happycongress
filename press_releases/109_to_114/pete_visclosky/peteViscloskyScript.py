# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 21:45:38 2019
...
baseURL = 'https://visclosky.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 67):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://visclosky.house.gov'+url
...
text_file = open("peteViscloskyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("peteViscloskyPressErrors.txt", "w")
