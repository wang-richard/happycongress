# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 15:14:21 2019
...
baseURL = 'https://larson.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 170):
    ...
    try:   
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://larson.house.gov'+url
...
text_file = open("johnLarsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnLarsonPressErrors.txt", "w")
