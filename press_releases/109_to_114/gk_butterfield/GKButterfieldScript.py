# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 17:55:50 2019
...
baseURL = 'https://butterfield.house.gov/media-center/press-releases?page='
...
for counter in range(1, 65):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://butterfield.house.gov'+url
...
text_file = open("GKButterfieldPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("GKButterfieldPressErrors.txt", "w")
