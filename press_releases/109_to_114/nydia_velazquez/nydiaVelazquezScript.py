# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 18:11:06 2019
...
baseURL = 'https://velazquez.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 74):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://velazquez.house.gov'+url
...
text_file = open("nydiaVelazquezPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("nydiaVelazquezPressErrors.txt", "w")
