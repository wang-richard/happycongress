# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 19:21:35 2019
...
baseURL = 'https://matsui.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='

urlsList = []
errorsList = []
for counter in range(1, 172):
    ...
    try:
        ...
        for link in a:
            url = link.attrs['href']
            url = url.strip()
            pressURL = 'https://matsui.house.gov/news/'+url
...
text_file = open("dorisMatsuiPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("dorisMatsuiPressErrors.txt", "w")
