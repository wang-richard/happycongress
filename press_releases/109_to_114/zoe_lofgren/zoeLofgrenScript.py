# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 15:45:03 2019
...
baseURL = 'https://lofgren.house.gov/media/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 76):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lofgren.house.gov'+url
...
text_file = open("zoeLofgrenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("zoeLofgrenPressErrors.txt", "w")
