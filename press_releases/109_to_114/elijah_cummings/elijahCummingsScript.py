# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 12:48:36 2019
...
baseURL = 'https://cummings.house.gov/media-center/press-releases?page='

urlsList = []
errorsList = []
for counter in range(0, 116):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://cummings.house.gov'+url
...
text_file = open("elijahCummingsPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("elijahCummingsPressErrors.txt", "w")
