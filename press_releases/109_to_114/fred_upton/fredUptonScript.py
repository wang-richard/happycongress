# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 17:29:09 2019
...
baseURL = 'https://upton.house.gov/news/documentquery.aspx?DocumentTypeID=1828&Page='
...
for counter in range(1, 91):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://upton.house.gov/news/'+url
...
text_file = open("fredUptonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("fredUptonPressErrors.txt", "w")
