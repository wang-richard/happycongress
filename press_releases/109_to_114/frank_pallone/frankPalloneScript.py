# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 17:14:31 2019
...
baseURL = 'https://pallone.house.gov/media/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 243):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://pallone.house.gov'+url
...
text_file = open("frankPallonePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("frankPallonePressErrors.txt", "w")
