# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 19:20:25 2019
...
baseURL = 'https://www.stabenow.senate.gov/news?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 59):
    ...
    try: 
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.stabenow.senate.gov'+url
...
text_file = open("debbieStabenowPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("debbieStabenowPressErrors.txt", "w")
