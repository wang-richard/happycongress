# -*- coding: utf-8 -*-
"""
Created on Sat Mar 09 17:06:11 2019
...
baseURL = 'https://algreen.house.gov/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 57):
    ...
    try:
        ...
        for link in a.findAll('h4'):
            url = link.find('a').attrs['href']
            pressURL = 'https://algreen.house.gov'+url
...
text_file = open("alGreenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("alGreenPressErrors.txt", "w")
