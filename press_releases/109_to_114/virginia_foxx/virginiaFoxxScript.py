# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 18:12:27 2019
...
baseURL = 'https://foxx.house.gov/news/documentquery.aspx?DocumentTypeID=2367&Page='
urlsList = []
errorsList = []
for counter in range(1, 88):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://foxx.house.gov/news/'+url
...
text_file = open("virginiaFoxxPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("virginiaFoxxPressErrors.txt", "w")
