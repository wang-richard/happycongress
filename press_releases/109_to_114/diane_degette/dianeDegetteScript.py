# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 15:40:05 2019
...
baseURL = 'https://degette.house.gov/media-center/press-releases?page='
...
for counter in range(1, 98):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://degette.house.gov'+url
...
text_file = open("dianeDegettePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("dianeDegettePressErrors.txt", "w")
