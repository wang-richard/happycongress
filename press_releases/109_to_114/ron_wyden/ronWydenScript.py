# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 16:14:41 2019
...
baseURL = 'https://www.wyden.senate.gov/news/press-releases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 114):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.wyden.senate.gov'+url
...
text_file = open("ronWydenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("ronWydenPressErrors.txt", "w")
