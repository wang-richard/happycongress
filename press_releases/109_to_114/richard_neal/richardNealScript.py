# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 23:59:09 2019
...
baseURL = 'https://neal.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 48):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://neal.house.gov'+url
...
text_file = open("richardNealPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("richardNealPressErrors.txt", "w")
