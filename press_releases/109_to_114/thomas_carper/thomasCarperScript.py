# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 16:40:21 2019
...
baseURL = 'https://www.carper.senate.gov/public/index.cfm/pressreleases?page='
urlsList = []
errorsList = []
for counter in range(8, 251):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.carper.senate.gov'+url
...
text_file = open("thomasCarperPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("thomasCarperPressErrors.txt", "w")
