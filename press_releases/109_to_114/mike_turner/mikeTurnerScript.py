# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 16:52:05 2019
...
baseURL = 'https://turner.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 92):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://turner.house.gov'+url
...
text_file = open("mikeTurnerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeTurnerPressErrors.txt", "w")
