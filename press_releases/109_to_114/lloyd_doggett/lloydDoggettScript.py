# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 16:17:06 2019
...
baseURL = 'https://doggett.house.gov/media-center?page='
urlsList = []
errorsList = []
for counter in range(1, 112):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://doggett.house.gov'+url
...
text_file = open("lloydDoggettPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lloydDoggettPressErrors.txt", "w")
