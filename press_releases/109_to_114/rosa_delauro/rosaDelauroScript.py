...
baseURL = 'https://delauro.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(3, 286):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://delauro.house.gov'+url
...
text_file = open("rosaDelauroPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("rosaDelauroPressErrors.txt", "w")
