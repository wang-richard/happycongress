# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 16:41:37 2019
...
baseURL = 'https://bishop.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 95):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://bishop.house.gov'+url
...
text_file = open("sanfordBishopJrPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("sanfordBishopJrPressErrors.txt", "w")
