# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 12:32:04 2019
...
baseURL = 'https://larsen.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 164):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://larsen.house.gov'+url
...
text_file = open("rickLarsenPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("rickLarsenPressErrors.txt", "w")
