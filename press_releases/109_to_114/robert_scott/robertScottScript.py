# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 14:58:50 2019
...
baseURL = 'https://bobbyscott.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 104):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://bobbyscott.house.gov'+url
...
text_file = open("robertScottPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("robertScottPressErrors.txt", "w")
