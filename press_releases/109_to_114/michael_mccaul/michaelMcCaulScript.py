# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 01:01:53 2019
...
baseURL = 'https://mccaul.house.gov/media-center/press-releases?page='
...
for counter in range(1, 76):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mccaul.house.gov'+url
...
text_file = open("michaelMcCaulPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("michaelMcCaulPressErrors.txt", "w")
