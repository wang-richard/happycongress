# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 21:33:14 2019
...
baseURL = 'https://susandavis.house.gov/news/documentquery.aspx?DocumentTypeID=1782&Page='
urlsList = []
errorsList = []
for counter in range(1, 34):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://susandavis.house.gov/news/'+url
...
text_file = open("susanDavisPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("susanDavisPressErrors.txt", "w")
