# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 18:34:12 2019
...
baseURL = 'https://serrano.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 109):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://serrano.house.gov'+url
...
text_file = open("joseSerranoPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("joseSerranoPressErrors.txt", "w")
