# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 23:00:10 2019
...
baseURL = 'https://meeks.house.gov/media/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 81):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://meeks.house.gov'+url
...
text_file = open("gregoryMeeksPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("gregoryMeeksPressErrors.txt", "w")
