# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 19:28:26 2019
...
urlsList = []
errorsList = []
baseURL = 'https://www.shelby.senate.gov/public/index.cfm/newsreleases?page='
for counter in range(1, 189):
...
text_file = open("richardShelbyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("richardShelbyPressErrors.txt", "w")
