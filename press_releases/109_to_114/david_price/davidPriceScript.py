# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 15:42:31 2019
...
baseURL = 'https://price.house.gov/newsroom/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 103):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://price.house.gov'+url
...
text_file = open("davidPricePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("davidPricePressErrors.txt", "w")
