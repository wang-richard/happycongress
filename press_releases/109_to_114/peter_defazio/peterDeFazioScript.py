# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 22:08:21 2019
...
baseURL = 'https://defazio.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 94):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://defazio.house.gov'+url
...
text_file = open("peterDeFazioPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("peterDeFazioPressErrors.txt", "w")
