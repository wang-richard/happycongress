# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 17:58:30 2019
...
baseURL = 'https://lowey.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 137):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lowey.house.gov'+url
...
text_file = open("nitaLoweyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("nitaLoweyPressErrors.txt", "w")
