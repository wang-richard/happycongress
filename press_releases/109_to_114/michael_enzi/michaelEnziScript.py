# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 15:12:56 2019
...
baseURL = 'https://www.enzi.senate.gov/public/index.cfm/news-releases?page='
urlsList = []
errorsList = []
for counter in range(3, 223):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.enzi.senate.gov'+url
...
text_file = open("michaelEnziPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("michaelEnziPressErrors.txt", "w")
