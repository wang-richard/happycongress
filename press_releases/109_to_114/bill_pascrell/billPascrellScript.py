# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 17:13:14 2019
...
baseURL = 'https://pascrell.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='

urlsList = []
errorsList = []
for counter in range(1, 162):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://pascrell.house.gov/news/'+url
...
for targetURL in urlsList:
    ...
    try:
        ...
        a = soup.find('div',attrs={"class":"newsbody clearfix"})
...
text_file = open("billPascrellPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
    counter+=1
text_file.close()

text_file = open("billPascrellPressErrors.txt", "w")
