# -*- coding: utf-8 -*-
"""
Created on Mon Apr 08 13:38:01 2019
...
baseURL = 'https://www.thune.senate.gov/public/index.cfm/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 88):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.thune.senate.gov'+url
...
text_file = open("johnThunePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnThunePressErrors.txt", "w")
