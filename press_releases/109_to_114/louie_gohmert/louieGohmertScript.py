# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 18:34:55 2019
...
baseURL = 'https://gohmert.house.gov/news/documentquery.aspx?DocumentTypeID=1954&Page='
urlsList = []
errorsList = []
for counter in range(1, 33):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://gohmert.house.gov/news/'+url
...
text_file = open("louieGohmertPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("louieGohmertPressErrors.txt", "w")
