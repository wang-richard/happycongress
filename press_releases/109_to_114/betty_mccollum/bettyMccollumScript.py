# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 14:55:48 2019
...
baseURL = 'https://mccollum.house.gov/media/press-releases?page='
...
for counter in range(1, 88):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mccollum.house.gov'+url
...
text_file = open("bettyMcCollumPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bettyMcCollumPressErrors.txt", "w")
