# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 10:32:33 2019
...
baseURL = 'https://fortenberry.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 39):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://fortenberry.house.gov'+url
...
text_file = open("jeffFortenberryPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jeffFortenberryPressErrors.txt", "w")
