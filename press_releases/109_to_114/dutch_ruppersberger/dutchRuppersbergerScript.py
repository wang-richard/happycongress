# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 20:41:07 2019
...
baseURL = 'https://ruppersberger.house.gov/news-room/press-releases?page='
...
for counter in range(1, 98):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://ruppersberger.house.gov'+url
...
text_file = open("dutchRuppersbergerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("dutchRuppersbergerPressErrors.txt", "w")
