# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 13:01:35 2019
...
baseURL = 'https://langevin.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 155):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://langevin.house.gov'+url
...
text_file = open("jimLangevinPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jimLangevinPressErrors.txt", "w")
