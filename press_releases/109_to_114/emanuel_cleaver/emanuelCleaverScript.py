# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 16:09:11 2019
...
baseURL = 'https://cleaver.house.gov/media-center/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 39):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://cleaver.house.gov'+url
...
text_file = open("emanuelCleaverPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("emanuelCleaverPressErrors.txt", "w")
