# -*- coding: utf-8 -*-
"""
Created on Mon Mar 25 00:07:56 2019
...
baseURL = 'https://www.feinstein.senate.gov/public/index.cfm/press-releases?page='
urlsList = []
errorsList = []
for counter in range(6, 147):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.feinstein.senate.gov'+url
...
text_file = open("dianneFeinsteinPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("dianneFeinsteinPressErrors.txt", "w")
