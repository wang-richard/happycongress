# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 14:40:48 2019
...
baseURL = 'https://benniethompson.house.gov/media/press-releases?page='
...
text_file = open("bennieThompsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bennieThompsonPressErrors.txt", "w")
