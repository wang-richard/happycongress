# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 17:25:17 2019
...
baseURL = 'https://pelosi.house.gov/news/press-releases?page='
urlsList = []
errorsList = []
for counter in range(6, 475):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://pelosi.house.gov'+url
...
text_file = open("nancyPelosiPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("nancyPelosiPressErrors.txt", "w")
