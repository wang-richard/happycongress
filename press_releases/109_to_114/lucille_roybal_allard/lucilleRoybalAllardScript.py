# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 19:53:44 2019
...
baseURL = 'https://roybal-allard.house.gov/news/documentquery.aspx?DocumentTypeID=1465&Page='
urlsList = []
errorsList = []
for counter in range(1, 177):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://roybal-allard.house.gov/news/'+url
...
text_file = open("lucilleRoybalAllardPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lucilleRoybalAllardPressErrors.txt", "w")
