# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 08:58:51 2019
...
baseURL = 'https://halrogers.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 98):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://halrogers.house.gov'+url
...
text_file = open("halRogersPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("halRogersPressErrors.txt", "w")
