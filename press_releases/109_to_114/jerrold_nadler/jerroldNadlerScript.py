# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 10:54:17 2019
...
baseURL = 'https://nadler.house.gov/news/documentquery.aspx?DocumentTypeID=1753&Page='
urlsList = []
errorsList = []
for counter in range(1, 191):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://nadler.house.gov/news/'+url
...
text_file = open("jerroldNadlerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jerroldNadlerPressErrors.txt", "w")
