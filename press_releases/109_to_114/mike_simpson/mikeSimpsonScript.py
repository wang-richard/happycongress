# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 16:13:59 2019
...
baseURL = 'https://simpson.house.gov/news/documentquery.aspx?DocumentTypeID=1515&Page='
urlsList = []
errorsList = []
for counter in range(1, 79):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://simpson.house.gov/news/'+url
...
text_file = open("mikeSimpsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeSimpsonPressErrors.txt", "w")
