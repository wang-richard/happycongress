# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 10:08:44 2019
...
baseURL = 'https://sensenbrenner.house.gov/press-releases-statements?page='
urlsList = []
errorsList = []
for counter in range(1, 18):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://sensenbrenner.house.gov'+url
...
text_file = open("jamesSensenbrennerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jamesSensenbrennerPressErrors.txt", "w")
