# -*- coding: utf-8 -*-
"""
Created on Sun Apr 07 18:09:12 2019
...
baseURL = 'https://www.burr.senate.gov/press/releases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 77):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.burr.senate.gov'+url
...
text_file = open("richardBurrPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("richardBurrPressErrors.txt", "w")
