# -*- coding: utf-8 -*-
"""
Created on Mon Apr 08 21:55:24 2019
...
baseURL = 'https://www.alexander.senate.gov/public/index.cfm/pressreleases?page='
urlsList = []
errorsList = []
for counter in range(9, 400):
...
for targetURL in urlsList:
    ...
    try:
        ...
        a = soup.find('div', attrs={"class":"header"})
        date = a.find('h4').get_text()
...
text_file = open("lamarAlexanderPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lamarAlexanderPressErrors.txt", "w")
