# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 20:20:15 2019
...
baseURL = 'https://conaway.house.gov/news/documentquery.aspx?DocumentTypeID=1279&Page='
urlsList = []
errorsList = []
for counter in range(1, 70):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://conaway.house.gov/news/'+url
...
text_file = open("michaelConawayPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("michaelConawayPressErrors.txt", "w")
