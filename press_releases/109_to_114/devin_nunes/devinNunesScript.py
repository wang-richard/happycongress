# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 15:26:19 2019
...
baseURL = 'https://nunes.house.gov/news/documentquery.aspx?DocumentTypeID=2133&Page='
...
for counter in range(1, 13):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://nunes.house.gov/news/'+url
...
text_file = open("devinNunesPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("devinNunesPressErrors.txt", "w")
