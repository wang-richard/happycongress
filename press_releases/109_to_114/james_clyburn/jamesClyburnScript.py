# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 09:33:09 2019
...
baseURL = 'https://clyburn.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 40):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://clyburn.house.gov'+url
...
text_file = open("jamesClyburnPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jamesClyburnPressErrors.txt", "w")
