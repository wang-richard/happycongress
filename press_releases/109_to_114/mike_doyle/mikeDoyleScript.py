# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 01:41:30 2019
...
baseURL = 'https://doyle.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 41):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://doyle.house.gov'+url
...
text_file = open("mikeDoylePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeDoylePressErrors.txt", "w")
