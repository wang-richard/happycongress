# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 16:34:57 2019
...
baseURL = 'https://calvert.house.gov/media/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 72):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://calvert.house.gov'+url
...
text_file = open("kenCalvertPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("kenCalvertPressErrors.txt", "w")
