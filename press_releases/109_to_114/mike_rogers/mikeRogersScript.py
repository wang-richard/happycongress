# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 02:14:39 2019
...
baseURL = 'https://mikerogers.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
urlsList = []
errorsList = []
for counter in range(1, 62):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mikerogers.house.gov/news/'+url
...
for targetURL in urlsList:
    ...
    try:
        ...
        a = soup.find('div',attrs={"class":"main-newscopy"})
...
text_file = open("mikeRogersPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeRogersPressErrors.txt", "w")
