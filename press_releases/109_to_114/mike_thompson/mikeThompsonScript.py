# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 16:36:19 2019
...
baseURL = 'https://mikethompson.house.gov/newsroom/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 115):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://mikethompson.house.gov'+url
...
text_file = open("mikeThompsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mikeThompsonPressErrors.txt", "w")
