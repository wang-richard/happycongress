# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 12:40:16 2019
...
baseURL = 'https://kaptur.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(114, 120):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://kaptur.house.gov'+url
...
text_file = open("marcyKaptur2006Press.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("marcyKapturPress2006Errors.txt", "w")
