# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 21:40:15 2019
...
baseURL = 'https://www.schumer.senate.gov/newsroom/press-releases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 207):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.schumer.senate.gov'+url
...
text_file = open("charlesSchumerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("charlesSchumerPressErrors.txt", "w")
