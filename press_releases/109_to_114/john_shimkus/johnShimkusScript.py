# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 17:16:48 2019
...
baseURL = 'https://shimkus.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 18):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://shimkus.house.gov'+url
...
text_file = open("johnShimkusPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnShimkusPressErrors.txt", "w")
