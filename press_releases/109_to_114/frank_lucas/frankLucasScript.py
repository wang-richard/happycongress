# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 17:03:32 2019
...
baseURL = 'https://lucas.house.gov/press-releases?page='
...
for counter in range(0, 33):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://lucas.house.gov'+url
...
for targetURL in urlsList:
    ...
    try:
        ...
        a = soup.find('div',attrs={"class":"field-items"})
...
text_file = open("frankLucasPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("frankLucasPressErrors.txt", "w")
