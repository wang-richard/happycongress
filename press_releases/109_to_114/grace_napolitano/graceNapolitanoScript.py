# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 18:24:55 2019
...
baseURL = 'https://napolitano.house.gov/media/press-releases?page='
...
for counter in range(1, 56):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://napolitano.house.gov'+url
...
text_file = open("graceNapolitanoPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("graceNapolitanoPressErrors.txt", "w")
