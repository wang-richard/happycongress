# -*- coding: utf-8 -*-
"""
Created on Mon Apr 08 16:52:12 2019
...
baseURL = 'https://www.isakson.senate.gov/public/index.cfm/news-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 209):
...
text_file = open("johnnyIsaksonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnnyIsaksonPressErrors.txt", "w")
