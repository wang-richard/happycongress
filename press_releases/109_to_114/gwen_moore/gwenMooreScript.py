# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 23:13:05 2019
...
baseURL = 'https://gwenmoore.house.gov/news/documentquery.aspx?DocumentTypeID=27&Page='
urlsList = []
errorsList = []
for counter in range(1, 69):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://gwenmoore.house.gov/news/'+url
...
text_file = open("gwenMoorePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("gwenMoorePressErrors.txt", "w")
