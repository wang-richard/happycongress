# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 17:13:20 2019
...
baseURL = 'https://cole.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 95):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://cole.house.gov'+url
...
text_file = open("tomColePress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("tomColePressErrors.txt", "w")
