# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 12:43:40 2019
...
baseURL = 'https://robbishop.house.gov/media/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 68):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://robbishop.house.gov'+url
...
text_file = open("robBishopPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("robBishopPressErrors.txt", "w")
