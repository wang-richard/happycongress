# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 18:21:48 2019
@author: Richard
"""
...
baseURL = 'https://www.crapo.senate.gov/media/newsreleases?PageNum_rs='
urlsList = []
errorsList = []
for counter in range(1, 132):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.crapo.senate.gov'+url
...
text_file = open("michaelCrapoPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("michaelCrapoPressErrors.txt", "w")
