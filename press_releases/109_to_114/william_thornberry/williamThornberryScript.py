# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 15:15:36 2019
...
baseURL = 'https://thornberry.house.gov/news/documentquery.aspx?DocumentTypeID=1776&Page='
urlsList = []
errorsList = []
for counter in range(1, 48):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://thornberry.house.gov/news/'+url
...
text_file = open("williamThornberryPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("williamThornberryPressErrors.txt", "w")
