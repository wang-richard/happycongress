# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 12:49:11 2019
...
baseURL = 'https://kevinbrady.house.gov/news/documentquery.aspx?DocumentTypeID=2657&Page='
urlsList = []
errorsList = []
for counter in range(1, 98):
    ...
    try:
        ...
        for link in b:
            ...
            url = url.strip()
            pressURL = 'https://kevinbrady.house.gov/news/'+url
...
text_file = open("kevinBradyPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("kevinBradyPressErrors.txt", "w")
