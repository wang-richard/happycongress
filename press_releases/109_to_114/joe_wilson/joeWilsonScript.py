# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 14:47:25 2019
...
baseURL = 'https://joewilson.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 122):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://joewilson.house.gov'+url
...
text_file = open("joeWilsonPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("joeWilsonPressErrors.txt", "w")
