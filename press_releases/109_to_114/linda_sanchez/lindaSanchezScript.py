# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 15:32:05 2019
...
baseURL = 'https://lindasanchez.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 82):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lindasanchez.house.gov'+url
...
text_file = open("lindaSanchezPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("lindaSanchezPressErrors.txt", "w")
