# -*- coding: utf-8 -*-
"""
Created on Wed Mar 13 00:26:38 2019
...
baseURL = 'https://blumenauer.house.gov/media-center/press-releases?page='

urlsList = []
errorsList = []
for counter in range(1, 116):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://blumenauer.house.gov'+url
...
text_file = open("earlBlumenauerPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("earlBlumenauerPressErrors.txt", "w")
