# -*- coding: utf-8 -*-
"""
Created on Fri Mar 15 11:46:49 2019
...
baseURL = 'https://kaygranger.house.gov/media/press-releases?page='

urlsList = []
errorsList = []
for counter in range(48, 59):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://kaygranger.house.gov'+url
...
text_file = open("kayGranger2005Press.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("kayGrangerPress2005Errors.txt", "w")
