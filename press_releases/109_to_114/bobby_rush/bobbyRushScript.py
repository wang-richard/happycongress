# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 18:05:10 2019
...
baseURL = 'https://rush.house.gov/media-center/press-releases?page='
...
for counter in range(1, 90):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://rush.house.gov'+url
...
text_file = open("bobbyRushPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("bobbyRushPressErrors.txt", "w")
