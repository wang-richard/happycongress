# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 15:42:49 2019
...
baseURL = 'https://johnlewis.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 74):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://johnlewis.house.gov'+url
...
text_file = open("johnLewisPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("johnLewisPressErrors.txt", "w")
