# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 19:09:29 2019
...
baseURL = 'https://lynch.house.gov/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 69):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lynch.house.gov'+url
...
text_file = open("stephenLynchPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("stephenLynchPressErrors.txt", "w")
