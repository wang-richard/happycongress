# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 23:02:13 2019
...
baseURL = 'https://lacyclay.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(0, 37):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://lacyclay.house.gov'+url
...
text_file = open("williamLacyClayPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("williamLacyClayPressErrors.txt", "w")
