# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 11:13:55 2019
...
baseURL = 'https://cooper.house.gov/media-center/press-releases?page='
urlsList = []
errorsList = []
for counter in range(1, 69):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://cooper.house.gov'+url
...
text_file = open("jimCooperPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("jimCooperPressErrors.txt", "w")
