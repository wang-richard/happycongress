# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 01:27:51 2019
@author: Richard
"""
...
baseURL = 'https://www.mcconnell.senate.gov/public/index.cfm/pressreleases?page='
urlsList = []
errorsList = []
for counter in range(1, 146):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://www.mcconnell.senate.gov'+url
...
text_file = open("mitchMcConnellPress.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("mitchMcConnellPressErrors.txt", "w")
