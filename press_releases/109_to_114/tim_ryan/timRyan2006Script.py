# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 15:23:23 2019
...
baseURL = 'https://timryan.house.gov/media/press-releases?page='
urlsList = []
errorsList = []
for counter in range(142, 148):
    ...
    try:
        ...
        for link in a:
            ...
            url = url.strip()
            pressURL = 'https://timryan.house.gov'+url
...
text_file = open("timRyanPress2006.txt", "w")
for press in pressList:
    text_file.write(press.encode('utf-8')+"\n")
text_file.close()

text_file = open("timRyanPressErrors2006.txt", "w")
